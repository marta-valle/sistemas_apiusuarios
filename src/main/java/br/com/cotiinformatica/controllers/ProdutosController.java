...
public class ProdutosController {
	...
	//LEMBRAR!!! INICIAR AUTOMATICO @AUTOWIRED
	@Autowired
	private ProdutoRepository produtoRepository;

	@PostMapping
	public ResponseEntity<ProdutosGetResponseDto> post(@RequestBody @Valid ProdutoPostRequestDto dto) {
		...
		try {
			...
			// response vai receber o valor do parse(produto)
	...
	//O Método a seguir será usado para todos os retornos exceto GetAll.
	private ProdutosGetResponseDto parse(Produto produto) {
		...
		// neste ultimo, o total esta "chamando: preço * quantidade.
		return response;
	}
}
